...
- Update cloudflare/wrangler-action action to v3.15.0 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/139
- Update Songmu/tagpr action to v1.20.3 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/148
- Update softprops/action-gh-release action to v2.6.2 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/147
- Update dependency @playwright/test to v1.63.0 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/141
- Update dependency @crxjs/vite-plugin to v2.7.1 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/140
- Update dependency @types/chrome to ^0.2.0 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/142
- update by @futabooo in https://github.com/futabooo/notion-bar-colorize/pull/154
- Update actions/configure-pages action to v6 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/153
- Update actions/checkout action to v7 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/152
- Update tailwindcss monorepo to v4.3.3 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/149
- Support app.notion.com and fix text color adjustment on the new Notion UI by @futabooo in https://github.com/futabooo/notion-bar-colorize/pull/155
...
- Update Node.js to v24 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/131
- Update actions/setup-node action to v6 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/125
- Update dependency @types/chrome to v0.1.37 by @renovate[bot] in https://github.com/futabooo/notion-bar-colorize/pull/118
- fix: chromeのアカウントでsyncがうまくいってない問題の対応 by @futabooo in https://github.com/futabooo/notion-bar-colorize/pull/132
- 背景色に合わせて文字色やアイコンの色調整する by @futabooo in https://github.com/futabooo/notion-bar-colorize/pull/133
